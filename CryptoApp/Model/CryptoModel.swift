...
let cryptoCurrency = [
    ...
    CryptoModel(name: "BNB", symbol: "BNB", iconName: "bnb", value: 2665.64, evolution: -2.84),
    CryptoModel(name: "Tether", symbol: "USDT", iconName: "usdt", value: 665.54, evolution: +2.54),
    CryptoModel(name: "USD Coin", symbol: "USDC", iconName: "usdc", value: 665.64, evolution: +3.54),
]
